...
void UHeroGameplayAbility_PickUpStones::CollectStones()
{
	...
	UKismetSystemLibrary::BoxTraceMultiForObjects(
		...
		GetWarriorHeroCharacterFromActorInfo()->GetActorLocation() + -GetWarriorHeroCharacterFromActorInfo()->GetActorUpVector() * BoxTraceDistance,
		TraceBoxSize / 2.f,
		(-GetWarriorHeroCharacterFromActorInfo()->GetActorUpVector()).ToOrientationRotator(),
		StoneTraceChannel,
		false,
		TArray<AActor*>(),
